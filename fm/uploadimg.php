...
<link rel="stylesheet" type="text/css" href="css/uploadinging.css">
...
<body>
    <header>
        ...
        <div class="add-button">
            <a href="deleteimg.php">  Delete Image</a>
        </div>
    </header>
    <?php
...
$result=mysqli_query($conn,"INSERT INTO items(image,title) VALUES('$image_file','$title')"); 
if($result)
{
    $image_success=1;  
}
        ...
        <?php $res=mysqli_query($conn,"SELECT* from items ORDER by id DESC");
            while($row=mysqli_fetch_array($res)) 
            {
                echo '<tr> 
                  ...
                  <td>'.$row['title'].'</td> 
                  <td><a href="download.php?id='.$row['id'].'"></a>
